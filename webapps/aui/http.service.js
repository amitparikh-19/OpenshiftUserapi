...
function httpService($http) {
    ...
    var httpService = {
        ...
        formulateParams : formulateParams,
     ...
     */
		...
		case 'GET':
			...
			if(entityObj.id)
			{
				...
				request.params.params = formulateParams(entityObj.entity);
				request.params.entity = null;
				
				if (entityObj.pageable)
					{
						request.url = serviceUrl + "/pagesearch";
    ...
    function formulateParams(jsonObj)
    {
    	console.log(jsonObj)
